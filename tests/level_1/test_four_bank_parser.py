...
@pytest.mark.parametrize(
    ...
    [
        (
            SmsMessage(
                text="10000 99, 9874-2590-3658-4321 01.01.24 08:35 spent_in authcode 9874",
                author="denis pekshev",
                sent_at=datetime.datetime.strptime("31.10.2024 18:00", date_format),
            ),
            ...
            Expense(
                ...
                card=bank_card1,
                spent_in="spent_in",
                spent_at=datetime.datetime.strptime("31.10.2024 18:00", date_format),
            ),
        ),
        (
            SmsMessage(
                text="5 00, 9874-2590-3658-7654 01.01.24 08:35 spent_in authcode 9874",
                author="sarah connor",
                sent_at=datetime.datetime.strptime("31.10.2024 18:00", date_format),
            ),
            [bank_card1, bank_card2, bank_card3],
